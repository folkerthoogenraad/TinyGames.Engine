...
namespace PinguinGame.Gameplay
{
    public class IceLevelGraphicsSettings
    {
        ...
        public Color SnowColor { get; set; } = new Color(255, 255, 255);
        public Color SnowColorHighlighted { get; set; } = new Color(255, 186, 186);
        public Color SideColor { get; set; } = new Color(122, 168, 203);
        public Color SideWaterColor { get; set; } = new Color(49, 114, 153);
        public Color WaterColor { get; set; } = new Color(28, 84, 118);
    }
}
