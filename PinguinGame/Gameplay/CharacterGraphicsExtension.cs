...
namespace PinguinGame.Gameplay.Generic
{
    // This should be a component instead
    public static class CharacterGraphicsExtension
    {
        ...
        public static void DrawWalk(this CharacterGraphics self, Graphics2D graphics, GraphicsFacing facing, Vector2 position, float height, float animationTime)
        {
            RawDrawWalk(graphics, self.GetGraphicsForFacing(facing), position, height, animationTime);
        }
        public static void DrawIdle(this CharacterGraphics self, Graphics2D graphics, GraphicsFacing facing, Vector2 position, float height, float animationTime)
        {
            RawDrawIdle(graphics, self.GetGraphicsForFacing(facing), position, height, animationTime);
        }
        public static void DrawSlide(this CharacterGraphics self, Graphics2D graphics, GraphicsFacing facing, Vector2 position, float height, float animationTime)
        {
            RawDrawSlide(graphics, self.GetGraphicsForFacing(facing), position, height, animationTime);
        }
        public static void DrawDrown(this CharacterGraphics self, Graphics2D graphics, GraphicsFacing facing, Vector2 position, float height, float animationTime)
        {
