...
namespace PinguinGame.Gameplay
{
    public abstract class IceBlockBehaviour
    {
        ...
        public void Update(IEnumerable<IceBlockGameObject> blocks, float delta)
        {
            UpdateRelevant(blocks.Where(x => x.Behaviour == Name), delta);
        }

        public abstract void UpdateRelevant(IEnumerable<IceBlockGameObject> blocks, float delta);
    }
    ...
    public class RandomSinkIceBlockBehaviour : IceBlockBehaviour
    {
        ...
        public override void UpdateRelevant(IEnumerable<IceBlockGameObject> blocks, float delta)
        {
            SinkTimer -= delta;
