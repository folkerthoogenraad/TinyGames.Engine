...
namespace PinguinGame.Pinguins.Levels
{
    public class LevelGraphics
    {
        ...
        public LevelGraphicsSettings Settings { get; set; }

        public LevelGraphics(GraphicsDevice device, int width, int height, LevelGraphicsSettings settings)
        {
        ...
        public void Draw(Matrix matrix, Level level)
        {
        ...
        public void DrawShadows(Level level)
        {
        ...
        public void DrawUnderWater(Level level)
        {
            var vertex = new VertexPositionColorTexture()
            {
        ...
        public void DrawSnow(Level level)
        {
            var vertex = new VertexPositionColorTexture()
            {
        ...
        public void DrawWaterOutline(Level level)
        {
            foreach (var block in level.Blocks)
            {
                if (block.Height < 0) continue;
